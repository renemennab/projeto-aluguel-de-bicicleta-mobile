...
Caso de teste   | CTU-009 Usuário entende quais filtros podem ser utilizados na busca por bicicletas
|------|-----------------------------------------|
...
Caso de teste   | CTU-019 Usuário entende que é possível avaliar uma bike
|------|-----------------------------------------|
